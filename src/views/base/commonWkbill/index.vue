  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="100px" size="medium" class="ry_form">
      ...
      <el-form-item label="生产数量" prop="mknum">
        <el-input
          v-model.trim="queryParams.mknum"
          placeholder="请输入生产数量"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
      ...
      <el-form-item label="应付工资" prop="payable">
        <el-input
          v-model.trim="queryParams.payable"
          placeholder="请输入应付工资"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
      ...
      <el-form-item label="实付工资" prop="actPay">
        <el-input
          v-model.trim="queryParams.actPay"
          placeholder="请输入实付工资"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['base:CommonWkbill:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['base:CommonWkbill:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['base:CommonWkbill:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          @click="handleExport"
          v-hasPermi="['base:CommonWkbill:export']"
        >导出</el-button>
      </el-col>
