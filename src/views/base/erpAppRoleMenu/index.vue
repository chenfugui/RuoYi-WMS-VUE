...
<script>
import { listErpAppRoleMenu, getErpAppRoleMenu, delErpAppRoleMenu, addErpAppRoleMenu, updateErpAppRoleMenu, exportErpAppRoleMenu } from "@/api/base/erpAppRoleMenu";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除角色菜单表编号为"' + ids + '"的数据项？').then(function() {
    ...
    handleExport() {
      ...
      this.$modal.confirm('是否确认导出所有角色菜单表数据项？').then(() => {
