  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="100px" size="medium"
      ...
      <el-form-item label="生产批次" prop="batchId">
        <el-input v-model.trim="queryParams.batchId" placeholder="请输入生产批次" clearable size="small"
      ...
      <el-form-item label="实际生产数量" prop="realMakeNum">
        <el-input v-model.trim="queryParams.realMakeNum" placeholder="请输入实际生产数量" clearable size="small"
          @keyup.enter.native="handleQuery" />
      </el-form-item>
      ...
      <el-form-item label="扫描人" prop="scanBy">
        <el-input v-model.trim="queryParams.scanBy" placeholder="请输入扫描人" clearable size="small"
          @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item label="扫描时间" prop="scanTime">
        <el-date-picker clearable size="small" v-model="queryParams.scanTime" type="datetime"
          value-format="yyyy-MM-ddTHH:mm:ss" placeholder="选择扫描时间">
        </el-date-picker>
      </el-form-item>
      <template v-if="showMoreCondition">
        <el-form-item label="工资" prop="salary">
          <el-input v-model.trim="queryParams.salary" placeholder="请输入工资" clearable size="small"
            @keyup.enter.native="handleQuery" />
        </el-form-item>
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button type="primary" plain icon="el-icon-plus" size="mini" @click="handleAdd"
          v-hasPermi="['base:ErpProBatchExe:add']">新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="success" plain icon="el-icon-edit" size="mini" :disabled="single" @click="handleUpdate"
          v-hasPermi="['base:ErpProBatchExe:edit']">修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="danger" plain icon="el-icon-delete" size="mini" :disabled="multiple" @click="handleDelete"
          v-hasPermi="['base:ErpProBatchExe:remove']">删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="warning" plain icon="el-icon-download" size="mini" :loading="exportLoading"
          @click="handleExport" v-hasPermi="['base:ErpProBatchExe:export']">导出</el-button>
      </el-col>
    ...
    <WmsTable v-loading="loading" :data="ErpProBatchExeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="工资" align="center" prop="salary" v-if="columns[7].visible" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="50%" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="108px" inline class="dialog-form-two">
        ...
        <el-form-item label="扫描时间" prop="scanTime">
          <el-date-picker clearable size="small" v-model="form.scanTime" type="datetime"
            value-format="yyyy-MM-ddTHH:mm:ss" placeholder="选择扫描时间">
          </el-date-picker>
        </el-form-item>
        <el-form-item label="工资" prop="salary">
