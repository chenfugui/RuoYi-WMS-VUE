  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="100px" size="medium" class="ry_form">
      <el-form-item label="产品生产id" prop="proMakeId">
        <el-input
          v-model.trim="queryParams.proMakeId"
          placeholder="请输入产品生产id"
          clearable
          size="small"
      ...
      <el-form-item label="批次编码(同一个产品生产编码，批次号唯一)" prop="batchNo">
        <el-input
          ...
          placeholder="请输入批次编码(同一个产品生产编码，批次号唯一)"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
        />
      ...
      <el-form-item label="尺码名称" prop="sizeName">
        <el-input
          v-model.trim="queryParams.sizeName"
          placeholder="请输入尺码名称"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
      ...
      <el-form-item label="尺码编码" prop="sizeCode">
        <el-input
          v-model.trim="queryParams.sizeCode"
          placeholder="请输入尺码编码"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
      ...
      <el-form-item label="颜色id" prop="colorId">
        <el-input
          v-model.trim="queryParams.colorId"
          placeholder="请输入颜色id"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
      ...
      <el-form-item label="生产数量" prop="makeNum">
        <el-input
          v-model.trim="queryParams.makeNum"
          placeholder="请输入生产数量"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
      ...
      <el-form-item label="床次" prop="bedNo">
        <el-input
          v-model.trim="queryParams.bedNo"
          placeholder="请输入床次"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
      ...
      <el-form-item label="开始扎号" prop="pkgStartNo">
        <el-input
          v-model.trim="queryParams.pkgStartNo"
          placeholder="请输入开始扎号"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
      ...
      <el-form-item label="结束扎号" prop="pkgEndNo">
        <el-input
          v-model.trim="queryParams.pkgEndNo"
          placeholder="请输入结束扎号"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['base:ErpProMakeBatch:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['base:ErpProMakeBatch:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['base:ErpProMakeBatch:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          @click="handleExport"
          v-hasPermi="['base:ErpProMakeBatch:export']"
        >导出</el-button>
      </el-col>
    ...
    <WmsTable v-loading="loading" :data="ErpProMakeBatchList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="创建人" align="center" prop="creater" v-if="columns[15].visible"/>
      <el-table-column label="更新人" align="center" prop="updater" v-if="columns[16].visible"/>
      <el-table-column label="dr 1 正常  2  删除" align="center" prop="dr" v-if="columns[17].visible"/>
      <el-table-column label="顺序号" align="center" prop="seqno" v-if="columns[18].visible"/>
    ...
    return {
      ...
      columns: [
            ...
            { key: 16, label: "创建人", visible:  false  },
                ...
                { key: 20, label: "dr 1 正常  2  删除", visible:  false  },
