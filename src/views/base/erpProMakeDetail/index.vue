  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="100px" size="medium" class="ry_form">
      ...
      <el-form-item label="布料ID" prop="clothId">
        <el-input
          v-model.trim="queryParams.clothId"
          placeholder="请输入布料ID"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
      ...
      <el-form-item label="布料编码" prop="clothCode">
        <el-input
          v-model.trim="queryParams.clothCode"
          placeholder="请输入布料编码"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
      ...
      <el-form-item label="布料名称" prop="clothName">
        <el-input
          v-model.trim="queryParams.clothName"
          placeholder="请输入布料名称"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['base:ErpProMakeDetail:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['base:ErpProMakeDetail:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['base:ErpProMakeDetail:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          @click="handleExport"
          v-hasPermi="['base:ErpProMakeDetail:export']"
        >导出</el-button>
      </el-col>
    ...
    <WmsTable v-loading="loading" :data="ErpProMakeDetailList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="创建人" align="center" prop="creater" v-if="columns[9].visible"/>
      <el-table-column label="更新人" align="center" prop="updater" v-if="columns[10].visible"/>
      <el-table-column label="dr 1 正常  2  删除" align="center" prop="dr" v-if="columns[11].visible"/>
      <el-table-column label="单位id" align="center" prop="empId" v-if="columns[12].visible"/>
    ...
    return {
      ...
      columns: [
            ...
            { key: 10, label: "创建人", visible:  false  },
                ...
                { key: 14, label: "dr 1 正常  2  删除", visible:  false  },
